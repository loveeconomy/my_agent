...
class Tools():
    ...
    ''' 
    @staticmethod
    def _find_running_weixin_process():
    ...
    def is_weixin_running()->bool:
        ...
        try:
            ...
            return Tools._find_running_weixin_process() is not None
    ...
    def where_weixin(copy_to_clipboard:bool=False)->str:
        ...
        if Tools.is_weixin_running():
            ...
            try:
                ...
                process=Tools._find_running_weixin_process()
                if process:
                    try:
                        weixin_path=process.exe()
                    except (psutil.NoSuchProcess, psutil.AccessDenied, psutil.ZombieProcess):
                        weixin_path=''
            if weixin_path:
                #规范化路径并检查文件是否存在
